...
using SistemaGestionFerreteria.Models.ViewModel;
...
namespace SistemaGestionFerreteria.Controllers
{
    public class ProductosController : Controller
    {
        ...
        {
            var CreateViewModeL = new ProductoCreateViewModel
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Precio,Stock,CategoriaId,ProveedorId")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
